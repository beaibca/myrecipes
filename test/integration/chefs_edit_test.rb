...
class ChefsEditTest < ActionDispatch::IntegrationTest
  def setup
    @chef = Chef.create!(chefname: "beaibca", email: "beaibca@example.com",
  ...
  test "accept edit attempt by admin user" do
    ...
    get edit_chef_path(@chef)
    assert_template 'chefs/edit'
    patch chef_path, params: {chef: {chefname: "beaibca3", email: "beaibca3@gmail.com"} }
    assert_redirected_to @chef
    assert_not flash.empty?
    @chef.reload
    assert_match "beaibca3", @chef.chefname
    assert_match "beaibca3@gmail.com", @chef.email
  end
  ...
  test "redirect edit attempt by another non-admin user" do
    ...
    @chef.reload
    assert_match "beaibca", @chef.chefname
    assert_match "beaibca@example.com", @chef.email
  end
end
